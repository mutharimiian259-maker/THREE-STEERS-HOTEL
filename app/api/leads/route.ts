...
/* =============================================================
   LEAD EVENT WHITELIST
   Intentional subset of core EventType.
   Only high-signal events are accepted by the lead ingestion API.
   Add values here when new lead-relevant events are defined in core.
   ============================================================= */

const LEAD_EVENT_TYPES = new Set<EventType>([
  "page_view",
  "room_view",
  "whatsapp_click",
  "call_click",
...
function isValidType(type: string): type is EventType {
  return LEAD_EVENT_TYPES.has(type as EventType);
}
